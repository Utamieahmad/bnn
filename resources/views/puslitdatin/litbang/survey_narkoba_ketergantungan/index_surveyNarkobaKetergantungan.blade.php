						...
						<div class="x_title">
							...
							<li class="">
								<a href="{{route('print_page_puslitdatin',['survey_narkoba_ketergantungan',$kondisi])}}" class="btn btn-lg btn-round btn-dark">
					              ...
					              <li class="">
					              <a href="#" class="btn btn-lg btn-round btn-success" data-toggle="modal" data-target="#modal_report_excel" onClick="reportExcel(event,this)" data-url="{{url('puslitdatin/bidang_litbang/downloadsurveyketergantungan')}}">
