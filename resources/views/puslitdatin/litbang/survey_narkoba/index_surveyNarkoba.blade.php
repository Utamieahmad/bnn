					...
					<div class="x_panel">
						<div class="x_title">
							...
							<li class="">
				              ...
				              <li class="">
				              <a href="#" class="btn btn-lg btn-round btn-success" data-toggle="modal" data-target="#modal_report_excel" onClick="reportExcel(event,this)" data-url="{{url('puslitdatin/bidang_litbang/downloadsurveynarkoba')}}">
