							...
							<li class="">
								<a href="{{route('print_page_irtama',['irtama_riktu',$kondisi])}}" class="btn btn-lg btn-round btn-dark">
									<i class="fa fa-print"></i> Cetak
                                                        ...
                                                        <li class="">
							<a href="#" class="btn btn-lg btn-round btn-success" data-toggle="modal" data-target="#modal_report_excel" onClick="reportExcel(event,this)" data-url="{{url('irtama/download_laporan', ['irtama_riktu'])}}">
