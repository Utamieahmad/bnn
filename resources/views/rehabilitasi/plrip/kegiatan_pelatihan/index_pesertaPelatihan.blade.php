									...
									@foreach($peserta as $p)
										<tr>
											...
											<td class="actionTable">
												<button type="button" class="btn btn-primary button-edit" data-target="{{$p->id_detail}}" onClick="open_modalEditPesertaPelatihan(event,this,'/rehabilitasi/dir_plrip/edit_peserta_pelatihan_plrip/','modal_edit_form')"><i class="fa fa-pencil"></i></button>
