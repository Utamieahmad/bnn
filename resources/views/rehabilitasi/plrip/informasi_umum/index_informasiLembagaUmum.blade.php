            ...
            <ul class="nav navbar-right panel_toolbox">
              ...
              <li class="">
                ...
                @endif
						...
						<li class="">
						<a href="#" class="btn btn-lg btn-round btn-success" data-toggle="modal" data-target="#modal_report_excel" onClick="reportExcel(event,this)" data-url="{{url('rehabilitasi/print_page_rehabilitasi/downloadPlrip')}}">
