...
<div class="modal-dialog">
  <div class="modal-content modal-color">
    ...
    <div class="modal-body">
      <ul class="">
        <li @php if(!in_array(12, $menu))  echo 'style="display:none;"'; @endphp style="margin: 15px 0px;"><span style="color:white; font-size:16px; font-weight:bold;">Direktorat Narkotika</span>
            <ul class="">
        ...
        <li @php if(!in_array(13, $menu))  echo 'style="display:none;"'; @endphp style="margin: 15px 0px;"><span style="color:white; font-size:16px; font-weight:bold;">Direktorat Psikotropika dan Prekursor</span>
            <ul class="">
        ...
        <li @php if(!in_array(14, $menu))  echo 'style="display:none;"'; @endphp style="margin: 15px 0px;"><span style="color:white; font-size:16px; font-weight:bold;">Direktorat TPPU</span>
            <ul class="">
        ...
        <li @php if(!in_array(15, $menu))  echo 'style="display:none;"'; @endphp style="margin: 15px 0px;"><span style="color:white; font-size:16px; font-weight:bold;">Direktorat Intelijen</span>
            <ul class="">
        ...
        <li @php if(!in_array(16, $menu))  echo 'style="display:none;"'; @endphp style="margin: 15px 0px;"><span style="color:white; font-size:16px; font-weight:bold;">Direktorat Wastahti</span>
            <ul class="">
        ...
        <li @php if(!in_array(17, $menu))  echo 'style="display:none;"'; @endphp style="margin: 15px 0px;"><span style="color:white; font-size:16px; font-weight:bold;">Direktorat Penindakan dan Pengejaran</span>
            <ul class="">
        ...
        <li @php if(!in_array(18, $menu))  echo 'style="display:none;"'; @endphp style="margin: 15px 0px;"><span style="color:white; font-size:16px; font-weight:bold;">Direktorat Interdiksi</span>
            <ul class="">
